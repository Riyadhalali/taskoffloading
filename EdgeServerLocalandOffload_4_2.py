...
class EdgeServer:
    ...
    def process_locally(self, task):
        ...
        # Add this print statement to show when a local task is completed
        print(
...
edge_server = EdgeServer(env, 'EdgeServer', cloud_env, cpu_power=1.5, memory=8, max_concurrent_tasks=5)
